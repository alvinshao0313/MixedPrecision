...
def parser_gen():
    ...
    parser.add_argument('--use_r3', action=argparse.BooleanOptionalAction, default=False,
    ...
    parser.add_argument('--w_fp4', type=str, default=None, choices=[None, 'e2m1_0', 'e2m1', 'e3m0', 'e3m0_0'],
                        help='Apply fp4 rotation (default: False)')
    parser.add_argument('--a_fp4', type=str, default=None, choices=[None, 'e2m1_0', 'e2m1', 'e3m0', 'e3m0_0'],
                        help='Apply fp4 rotation (default: False)')
    # parser.add_argument('--mp_fp4', type=str, default=None, choices=[None, 'e2m1_0', 'e2m1', 'e3m0', 'e3m0_0'],
    #                     help='Apply fp4 rotation (default: False)')
    ...
    parser.add_argument('--up_out_bits', type=int, default=16,
                        help='''Number of bits for Up Projection and Gate Projection outputs quantization.''')
    parser.add_argument('--first_token_protect', action=argparse.BooleanOptionalAction, default=False,
                        help='''Use the first token protect.''')

    parser.add_argument('--mix_precision', action=argparse.BooleanOptionalAction, default=False,
                        help='''Use mixed precision.''')
    parser.add_argument('--protect_threshold', type=float, default=3,
                        help='''Threshold for the mixed precision protect.''')
    parser.add_argument('--protected_quant', action=argparse.BooleanOptionalAction, default=False,
                        help='''Use protected quantization.''')
